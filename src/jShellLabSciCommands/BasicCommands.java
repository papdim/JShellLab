...
import jShellLabSci.help.PDFHelpFrame;
import java.io.*;
...
public class BasicCommands {
 ...
 public static void drows(int N) {
     jShellLabSci.math.array.DoubleArray.maxRows = N;
 }
 
 public static void dcols(int N) {
     jShellLabSci.math.array.DoubleArray.maxCols = N;
 }
...
public static void help(String command) throws FileNotFoundException, IOException  {
    String fullFileName =  GlobalValues.jshellLabHelpPath+File.separator+command+".pdf";
...
public static String typeOf(Object currentVarValue)  {
  ...
  if ( currentVarValue instanceof jShellLabSci.math.array.Matrix)  {
      jShellLabSci.math.array.Matrix myMatrix = (jShellLabSci.math.array.Matrix) currentVarValue;
