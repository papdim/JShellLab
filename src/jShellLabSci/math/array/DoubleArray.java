...
import jShellLabSci.math.array.util.Function;
import jShellLabSci.math.array.util.IndexFunction;
import jShellLabSci.math.array.util.Random;
import jShellLabSci.math.array.util.Sorting;
...
public static String toString(double [][]d) {
    return jShellLabSci.math.array.Matrix.printArray(d);
}
        // print methods
...
return str.toString();
	 ...
	 * Must import jShellLabSci.math.array.util.*; to get Function interface.
