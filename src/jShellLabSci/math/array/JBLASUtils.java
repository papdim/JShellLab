...
jShellLabSci.math.array.Matrix.metaClass.multiply = { 
   jShellLabSci.math.array.Matrix m ->   // the input Matrix
    ...
    jShellLabSci.math.array.JBLASUtils.JBLASDoubleMatrixToDouble2D(mulRes)
}
