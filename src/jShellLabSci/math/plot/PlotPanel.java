...
import jShellLabSci.math.plot.canvas.Plot2DCanvas;
import jShellLabSci.math.plot.canvas.PlotCanvas;
import jShellLabSci.math.plot.components.LegendPanel;
import jShellLabSci.math.plot.components.PlotToolBar;
   ...
   /*   these methods allow the handling of axis by retrieving first a PlotPanel reference.
    t = inc(0, 0.01, 20);
        ...
        public void xlabel(String xLabelStr) {
            setAxisLabel(jShellLabSci.math.plot.PlotPanel.xAxisId, xLabelStr);
        }
        
        public void ylabel(String yLabelStr) {
            setAxisLabel(jShellLabSci.math.plot.PlotPanel.yAxisId, yLabelStr);
        }
        
        public void zlabel(String zLabelStr) {
            if (this instanceof  Plot3DPanel) {
               setAxisLabel(jShellLabSci.math.plot.PlotPanel.zAxisId, zLabelStr);
            }
        }
