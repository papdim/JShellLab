...
import jShellLabSci.math.plot.MatrixTablePanel;
import java.awt.*;
...
public class DatasFrame extends JFrame {
    ...
    // add a tab for each plot object
        for (jShellLabSci.math.plot.plots.Plot plot: plotCanvas.getPlots()) 
    ...
    public class DataPanel extends JPanel {
        ...
        jShellLabSci.math.plot.plots.Plot plot;
        DatasFrame dframe;

        public DataPanel(jShellLabSci.math.plot.plots.Plot _plot) {
            plot = _plot;
