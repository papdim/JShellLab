package jShellLabSci.math.plot;
...
// use for some plot operations  
   public void  passControllerContextToPlotContext()  {
    ...
    public void  setContinuousLine()  {
        jShellLabSci.math.plot.render.AbstractDrawer.line_type = jShellLabSci.math.plot.render.AbstractDrawer.CONTINOUS_LINE; 
        lineType = LineTypes.ContinuousLine;
    }
       // set drawing to dotted lines
    public void  setDottedLine()  { 
        jShellLabSci.math.plot.render.AbstractDrawer.line_type = jShellLabSci.math.plot.render.AbstractDrawer.DOTTED_LINE; 
        lineType =  LineTypes.DottedLine;
    }
       // set drawing to Round Dot
    public void  setRoundDotLine()  { 
        jShellLabSci.math.plot.render.AbstractDrawer.dot_type = jShellLabSci.math.plot.render.AbstractDrawer.ROUND_DOT;
        lineType = LineTypes.RoundDottedLine;
    }
       // set drawing to cross dot
    public void  setCrossDotLine()  { 
        jShellLabSci.math.plot.render.AbstractDrawer.dot_type = jShellLabSci.math.plot.render.AbstractDrawer.CROSS_DOT; 
        lineType = LineTypes.CrossDotLine;
    }
    // set drawing to thick line
    public void setThickLine() {
        jShellLabSci.math.plot.render.AbstractDrawer.line_type = jShellLabSci.math.plot.render.AbstractDrawer.THICK_LINE;
        lineType = LineTypes.ThickLine;
    }
        // set drawing to pattern line
    public void setPatternLine() {
        jShellLabSci.math.plot.render.AbstractDrawer.line_type = jShellLabSci.math.plot.render.AbstractDrawer.PATTERN_LINE;
        lineType = LineTypes.PatternLine;
    }

    
       // set font
    public void  setFont(java.awt.Font font)  { jShellLabSci.math.plot.PlotGlobals.defaultAbstractDrawerFont = font; } 
       // set Color
    public void  setColor(java.awt.Color  color)   { jShellLabSci.math.plot.PlotGlobals.defaultAbstractDrawerColor = color; } 
       // set line width
    public void  setlineWidth(int lw)   { jShellLabSci.math.plot.render.AbstractDrawer.line_width = lw; } 
    ...
    public void  setX( jShellLabSci.math.array.Vec  x)  { xData = x.getv(); }  // sets the x-data using Vec 
    public void  setY( jShellLabSci.math.array.Vec  y)  { yData = y.getv(); }  // sets the y-data using Vec 
    public void  setZ( jShellLabSci.math.array.Vec  z)  { zData = z.getv(); }  // sets the z-data using Vec 
    
    public void  setX( jShellLabSci.math.array.Matrix  x)  { xData = x.getv(); }  // sets the x-data using Matrix
    public void  setY( jShellLabSci.math.array.Matrix  y)  { yData = y.getv(); }  // sets the y-data using Matrix
    public void  setZ( jShellLabSci.math.array.Matrix  z)  { zData = z.getv(); }  // sets the z-data using Matrix 
    ...
    public void mkplot()  { 
        jShellLabSci.math.plot.plot.plot(xData, yData, jShellLabSci.math.plot.PlotGlobals.defaultAbstractDrawerColor, plotTitle2D);
        jShellLabSci.math.plot.plot.xlabel(xlabelStr);
        jShellLabSci.math.plot.plot.ylabel(ylabelStr);
 ...
 // perform the plot using the object's properties
    public void  mkplot3D()  { 
        ...
        jShellLabSci.math.plot.plot.plot(xData, yData, zData, jShellLabSci.math.plot.PlotGlobals.defaultAbstractDrawerColor,  plotTitle3D);
        jShellLabSci.math.plot.plot.xlabel(xlabelStr);
        jShellLabSci.math.plot.plot.ylabel(ylabelStr);
        jShellLabSci.math.plot.plot.zlabel(zlabelStr);
       }
 }
