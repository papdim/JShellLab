  ...
  public  RSyntaxDocument updateDocument()  {
   ...
   public  String   getSelectedTextOrCurrentLine() {
      ...
      //   form total word that is under caret position
       ...
       GlobalValues.textForCompletion = wordAtCursor; 
        ...
        public void clickEvalEquations() {
          ...
          String lines[]  = currentTextForEval.split("[\\r\\n]+");

          
            for (String line: lines) {
               if (line.trim().length()> 0) {
         
          GlobalValues.eq.process(line);
          System.out.println("evaluating equation: "+line);
               }
               }
    ...
    System.out.flush();
        ...
        GlobalValues.eq.printLookupOnly(currentTextForEval);
    ...
    System.out.flush();
        ...
        public void clickLookupMatrixResult() {
        ...
        var lookupString = "var "+currentTextForEval+ "="+"jshellLabGlobal.Interpreter.GlobalValues.eq.lookupDDRM("+"\""+currentTextForEval+"\""+");";
        System.out.println("evaluating "+lookupString);
        GlobalValues.jshell.eval(lookupString);
    ...
    System.out.flush();
        ...
        public void clickLookupIntResult() {
        ...
        var lookupString = "var "+currentTextForEval+ "="+"jshellLabGlobal.Interpreter.GlobalValues.eq.lookupInteger("+"\""+currentTextForEval+"\""+");";
        System.out.println("evaluating "+lookupString);
        GlobalValues.jshell.eval(lookupString);
        ...
        public void clickExecuteScriptEngine() {
            Runnable execCode = ()-> {
                ...
                try {
                    ...
                    {
                        System.out.println("kotlin engine==null");
                        return;
                    }

                        Object res = GlobalValues.kotlinEngine.eval(currentTextForEval); //, GlobalValues.globalBindings);
   ...
   /*             if (Kind==Snippet.Kind.VAR) {
          ...
          /*  System.out.println("VARS");
            jshellLabGlobal.Interpreter.GlobalValues.jshell.variables().forEach((v) -> {
                
                    String vn = v.name();
                   System.out.println("VNAME = "+vn);
                    if (vn.contains("$")==false) {
                   GlobalValues.eq.alias(v, vn);
                    System.out.println("aliasing "+vn);
                    }
                    });
            */
    ...
    GlobalValues.completionFrame.setVisible(true);
       ...
       break;
          ...
          // evaluate EJML equations
            ...
            case KeyEvent.VK_F8:
                clickLookupMatrixResult();
                e.consume();
                break;
                
                
            case KeyEvent.VK_F9:
                clickLookupIntResult();
                e.consume();
                break;
