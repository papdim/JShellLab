...
public class ProcessJShellLabSciPlotsInJar   extends JFrame {
...
*/
   ...
   public ProcessJShellLabSciPlotsInJar(String jarFile)
   {
      setTitle("jShellLabSci Plots  Examples  ");
      ...
      examplesLabel.setText("Selected jShellLabSci Plot example: ");
