...
public class detectClassPaths {
    ...
    // detects the .jar files of all the main jShellLab's libraries
      public static void detectClassPaths()
    {
        boolean      hostIsUnix = true;
         if (File.pathSeparatorChar==';')
             ...
             if (hostIsUnix) {    
        JavaGlobals.jarFilePath = jarPathOfClass("jshellLabExec.jshellLab.jshellLab").toString().replace("file:/", "/");   // jShellLab's main .jar
       ...
       JavaGlobals.LAPACKFile = jarPathOfClass("org.netlib.lapack.LAPACK").toString().replace("file:/",  "/");   // JLAPACK 
        ...
        JavaGlobals.jarFilePath = jarPathOfClass("jshellLabExec.jshellLab.jshellLab").toString().replace("file:/", "");
        JavaGlobals.javacppfile = jarPathOfClass("org.bytedeco.javacpp.DoublePointer").toString().replace("file:/", "");
        JavaGlobals.openblasfile = jarPathOfClass("org.bytedeco.javacpp.presets.openblas").toString().replace("file:/", "");
